...
#         # Declare ROS 2 params for color stacking priorities
...
#             # Read priorities from ROS 2 parameters
#             color_priorities = {
...
#             # Detect closest cube in ROI based on priority
...
#         # Publish the annotated undistorted frame
#         try:
...
#         # (Optional: keep local view for debugging)
#         # cv2.imshow("Detection Output", undistorted)
#         if cv2.waitKey(1) & 0xFF == ord('q'):
#             self.shutdown()
