...
static char moveit_msgs__msg__MotionPlanRequest__FIELD_NAME__workspace_parameters[] = "workspace_parameters";
static char moveit_msgs__msg__MotionPlanRequest__FIELD_NAME__start_state[] = "start_state";
static char moveit_msgs__msg__MotionPlanRequest__FIELD_NAME__goal_constraints[] = "goal_constraints";
static char moveit_msgs__msg__MotionPlanRequest__FIELD_NAME__path_constraints[] = "path_constraints";
static char moveit_msgs__msg__MotionPlanRequest__FIELD_NAME__trajectory_constraints[] = "trajectory_constraints";
static char moveit_msgs__msg__MotionPlanRequest__FIELD_NAME__reference_trajectories[] = "reference_trajectories";
static char moveit_msgs__msg__MotionPlanRequest__FIELD_NAME__pipeline_id[] = "pipeline_id";
static char moveit_msgs__msg__MotionPlanRequest__FIELD_NAME__planner_id[] = "planner_id";
static char moveit_msgs__msg__MotionPlanRequest__FIELD_NAME__group_name[] = "group_name";
static char moveit_msgs__msg__MotionPlanRequest__FIELD_NAME__num_planning_attempts[] = "num_planning_attempts";
static char moveit_msgs__msg__MotionPlanRequest__FIELD_NAME__allowed_planning_time[] = "allowed_planning_time";
static char moveit_msgs__msg__MotionPlanRequest__FIELD_NAME__max_velocity_scaling_factor[] = "max_velocity_scaling_factor";
static char moveit_msgs__msg__MotionPlanRequest__FIELD_NAME__max_acceleration_scaling_factor[] = "max_acceleration_scaling_factor";
static char moveit_msgs__msg__MotionPlanRequest__FIELD_NAME__cartesian_speed_limited_link[] = "cartesian_speed_limited_link";
static char moveit_msgs__msg__MotionPlanRequest__FIELD_NAME__max_cartesian_speed[] = "max_cartesian_speed";

static rosidl_runtime_c__type_description__Field moveit_msgs__msg__MotionPlanRequest__FIELDS[] = {
  {
    {moveit_msgs__msg__MotionPlanRequest__FIELD_NAME__workspace_parameters, 20, 20},
    {
  ...
  {
    {moveit_msgs__msg__MotionPlanRequest__FIELD_NAME__start_state, 11, 11},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {moveit_msgs__msg__MotionPlanRequest__FIELD_NAME__goal_constraints, 16, 16},
    {
  ...
  {
    {moveit_msgs__msg__MotionPlanRequest__FIELD_NAME__path_constraints, 16, 16},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {moveit_msgs__msg__MotionPlanRequest__FIELD_NAME__trajectory_constraints, 22, 22},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {moveit_msgs__msg__MotionPlanRequest__FIELD_NAME__reference_trajectories, 22, 22},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE_UNBOUNDED_SEQUENCE,
      0,
      0,
  ...
  {
    {moveit_msgs__msg__MotionPlanRequest__FIELD_NAME__pipeline_id, 11, 11},
    {
  ...
  {
    {moveit_msgs__msg__MotionPlanRequest__FIELD_NAME__planner_id, 10, 10},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_STRING,
      0,
      0,
  ...
  {
    {moveit_msgs__msg__MotionPlanRequest__FIELD_NAME__group_name, 10, 10},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_STRING,
      0,
      0,
  ...
  {
    {moveit_msgs__msg__MotionPlanRequest__FIELD_NAME__num_planning_attempts, 21, 21},
    {
  ...
  {
    {moveit_msgs__msg__MotionPlanRequest__FIELD_NAME__allowed_planning_time, 21, 21},
    {
  ...
  {
    {moveit_msgs__msg__MotionPlanRequest__FIELD_NAME__max_velocity_scaling_factor, 27, 27},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_DOUBLE,
      0,
      0,
  ...
  {
    {moveit_msgs__msg__MotionPlanRequest__FIELD_NAME__max_acceleration_scaling_factor, 31, 31},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_DOUBLE,
      0,
      0,
  ...
  {
    {moveit_msgs__msg__MotionPlanRequest__FIELD_NAME__cartesian_speed_limited_link, 28, 28},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_STRING,
      0,
      0,
  ...
  {
    {moveit_msgs__msg__MotionPlanRequest__FIELD_NAME__max_cartesian_speed, 19, 19},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_DOUBLE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription moveit_msgs__msg__MotionPlanRequest__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {moveit_msgs__msg__MotionPlanRequest__FIELDS, 15, 15},
    },
    {moveit_msgs__msg__MotionPlanRequest__REFERENCED_TYPE_DESCRIPTIONS, 38, 38},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[22].fields = moveit_msgs__msg__OrientationConstraint__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[23].fields = moveit_msgs__msg__PositionConstraint__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[24].fields = moveit_msgs__msg__RobotState__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[25].fields = moveit_msgs__msg__TrajectoryConstraints__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[27].fields = moveit_msgs__msg__WorkspaceParameters__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[28].fields = object_recognition_msgs__msg__ObjectType__get_type_description(NULL)->type_description.fields;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeSource source = {
    {moveit_msgs__msg__MotionPlanRequest__TYPE_NAME, 33, 33},
    {msg_encoding, 3, 3},
    {toplevel_type_raw_source, 2554, 2554},
  };
  return &source;
}
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *moveit_msgs__msg__MotionPlanRequest__get_individual_type_description_source(NULL),
    ...
    sources[23] = *moveit_msgs__msg__OrientationConstraint__get_individual_type_description_source(NULL);
    sources[24] = *moveit_msgs__msg__PositionConstraint__get_individual_type_description_source(NULL);
    sources[25] = *moveit_msgs__msg__RobotState__get_individual_type_description_source(NULL);
    sources[26] = *moveit_msgs__msg__TrajectoryConstraints__get_individual_type_description_source(NULL);
    sources[27] = *moveit_msgs__msg__VisibilityConstraint__get_individual_type_description_source(NULL);
    sources[28] = *moveit_msgs__msg__WorkspaceParameters__get_individual_type_description_source(NULL);
    sources[29] = *object_recognition_msgs__msg__ObjectType__get_individual_type_description_source(NULL);
