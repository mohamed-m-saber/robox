...
static char moveit_msgs__msg__WorkspaceParameters__FIELD_NAME__header[] = "header";
static char moveit_msgs__msg__WorkspaceParameters__FIELD_NAME__min_corner[] = "min_corner";
static char moveit_msgs__msg__WorkspaceParameters__FIELD_NAME__max_corner[] = "max_corner";

static rosidl_runtime_c__type_description__Field moveit_msgs__msg__WorkspaceParameters__FIELDS[] = {
  {
    {moveit_msgs__msg__WorkspaceParameters__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {moveit_msgs__msg__WorkspaceParameters__FIELD_NAME__min_corner, 10, 10},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {moveit_msgs__msg__WorkspaceParameters__FIELD_NAME__max_corner, 10, 10},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription moveit_msgs__msg__WorkspaceParameters__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {moveit_msgs__msg__WorkspaceParameters__FIELDS, 3, 3},
    },
    {moveit_msgs__msg__WorkspaceParameters__REFERENCED_TYPE_DESCRIPTIONS, 3, 3},
  };
  if (!constructed) {
...
moveit_msgs__msg__WorkspaceParameters__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *moveit_msgs__msg__WorkspaceParameters__get_individual_type_description_source(NULL),
