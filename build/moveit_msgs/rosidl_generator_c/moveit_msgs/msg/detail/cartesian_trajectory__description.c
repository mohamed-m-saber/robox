...
static char moveit_msgs__msg__CartesianTrajectory__FIELD_NAME__header[] = "header";
static char moveit_msgs__msg__CartesianTrajectory__FIELD_NAME__tracked_frame[] = "tracked_frame";
static char moveit_msgs__msg__CartesianTrajectory__FIELD_NAME__points[] = "points";

static rosidl_runtime_c__type_description__Field moveit_msgs__msg__CartesianTrajectory__FIELDS[] = {
  {
    {moveit_msgs__msg__CartesianTrajectory__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {moveit_msgs__msg__CartesianTrajectory__FIELD_NAME__tracked_frame, 13, 13},
    {
  ...
  {
    {moveit_msgs__msg__CartesianTrajectory__FIELD_NAME__points, 6, 6},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription moveit_msgs__msg__CartesianTrajectory__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {moveit_msgs__msg__CartesianTrajectory__FIELDS, 3, 3},
    },
    {moveit_msgs__msg__CartesianTrajectory__REFERENCED_TYPE_DESCRIPTIONS, 11, 11},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[9].fields = moveit_msgs__msg__CartesianTrajectoryPoint__get_type_description(NULL)->type_description.fields;
...
moveit_msgs__msg__CartesianTrajectory__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *moveit_msgs__msg__CartesianTrajectory__get_individual_type_description_source(NULL),
    ...
    sources[10] = *moveit_msgs__msg__CartesianTrajectoryPoint__get_individual_type_description_source(NULL);
