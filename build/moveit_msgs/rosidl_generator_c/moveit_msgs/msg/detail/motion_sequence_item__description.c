...
static char moveit_msgs__msg__MotionSequenceItem__FIELD_NAME__req[] = "req";
static char moveit_msgs__msg__MotionSequenceItem__FIELD_NAME__blend_radius[] = "blend_radius";

static rosidl_runtime_c__type_description__Field moveit_msgs__msg__MotionSequenceItem__FIELDS[] = {
  {
    {moveit_msgs__msg__MotionSequenceItem__FIELD_NAME__req, 3, 3},
    {
  ...
  {
    {moveit_msgs__msg__MotionSequenceItem__FIELD_NAME__blend_radius, 12, 12},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription moveit_msgs__msg__MotionSequenceItem__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {moveit_msgs__msg__MotionSequenceItem__FIELDS, 2, 2},
    },
    {moveit_msgs__msg__MotionSequenceItem__REFERENCED_TYPE_DESCRIPTIONS, 39, 39},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *moveit_msgs__msg__MotionSequenceItem__get_individual_type_description_source(NULL),
