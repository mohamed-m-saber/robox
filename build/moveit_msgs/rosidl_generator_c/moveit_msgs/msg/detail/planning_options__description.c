...
static char moveit_msgs__msg__PlanningOptions__FIELD_NAME__planning_scene_diff[] = "planning_scene_diff";
static char moveit_msgs__msg__PlanningOptions__FIELD_NAME__plan_only[] = "plan_only";
static char moveit_msgs__msg__PlanningOptions__FIELD_NAME__look_around[] = "look_around";
static char moveit_msgs__msg__PlanningOptions__FIELD_NAME__look_around_attempts[] = "look_around_attempts";
static char moveit_msgs__msg__PlanningOptions__FIELD_NAME__max_safe_execution_cost[] = "max_safe_execution_cost";
static char moveit_msgs__msg__PlanningOptions__FIELD_NAME__replan[] = "replan";
static char moveit_msgs__msg__PlanningOptions__FIELD_NAME__replan_attempts[] = "replan_attempts";
static char moveit_msgs__msg__PlanningOptions__FIELD_NAME__replan_delay[] = "replan_delay";

static rosidl_runtime_c__type_description__Field moveit_msgs__msg__PlanningOptions__FIELDS[] = {
  {
    {moveit_msgs__msg__PlanningOptions__FIELD_NAME__planning_scene_diff, 19, 19},
    {
  ...
  {
    {moveit_msgs__msg__PlanningOptions__FIELD_NAME__plan_only, 9, 9},
    {
  ...
  {
    {moveit_msgs__msg__PlanningOptions__FIELD_NAME__look_around, 11, 11},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_BOOLEAN,
      0,
      0,
  ...
  {
    {moveit_msgs__msg__PlanningOptions__FIELD_NAME__look_around_attempts, 20, 20},
    {
  ...
  {
    {moveit_msgs__msg__PlanningOptions__FIELD_NAME__max_safe_execution_cost, 23, 23},
    {
  ...
  {
    {moveit_msgs__msg__PlanningOptions__FIELD_NAME__replan, 6, 6},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_BOOLEAN,
      0,
      0,
  ...
  {
    {moveit_msgs__msg__PlanningOptions__FIELD_NAME__replan_attempts, 15, 15},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_INT32,
      0,
      0,
  ...
  {
    {moveit_msgs__msg__PlanningOptions__FIELD_NAME__replan_delay, 12, 12},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_DOUBLE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription moveit_msgs__msg__PlanningOptions__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {moveit_msgs__msg__PlanningOptions__FIELDS, 8, 8},
    },
    {moveit_msgs__msg__PlanningOptions__REFERENCED_TYPE_DESCRIPTIONS, 35, 35},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeSource source = {
    {moveit_msgs__msg__PlanningOptions__TYPE_NAME, 31, 31},
    {msg_encoding, 3, 3},
    {toplevel_type_raw_source, 1362, 1362},
  };
  return &source;
}
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *moveit_msgs__msg__PlanningOptions__get_individual_type_description_source(NULL),
