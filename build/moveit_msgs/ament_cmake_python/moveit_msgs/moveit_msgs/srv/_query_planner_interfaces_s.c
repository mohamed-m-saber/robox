...
bool moveit_msgs__srv__query_planner_interfaces__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.srv._query_planner_interfaces.QueryPlannerInterfaces_Request", full_classname_dest, 72) == 0);
  }
...
bool moveit_msgs__srv__query_planner_interfaces__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.srv._query_planner_interfaces.QueryPlannerInterfaces_Response", full_classname_dest, 73) == 0);
  }
...
bool moveit_msgs__srv__query_planner_interfaces__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.srv._query_planner_interfaces.QueryPlannerInterfaces_Event", full_classname_dest, 70) == 0);
  }
