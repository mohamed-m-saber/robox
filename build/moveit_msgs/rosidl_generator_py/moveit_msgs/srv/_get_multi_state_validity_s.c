...
bool moveit_msgs__srv__get_multi_state_validity__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.srv._get_multi_state_validity.GetMultiStateValidity_Request", full_classname_dest, 71) == 0);
  }
...
bool moveit_msgs__srv__get_multi_state_validity__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.srv._get_multi_state_validity.GetMultiStateValidity_Response", full_classname_dest, 72) == 0);
  }
...
bool moveit_msgs__srv__get_multi_state_validity__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.srv._get_multi_state_validity.GetMultiStateValidity_Event", full_classname_dest, 69) == 0);
  }
