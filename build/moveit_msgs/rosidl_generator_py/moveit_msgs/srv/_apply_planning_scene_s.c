...
bool moveit_msgs__srv__apply_planning_scene__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.srv._apply_planning_scene.ApplyPlanningScene_Request", full_classname_dest, 64) == 0);
  }
...
bool moveit_msgs__srv__apply_planning_scene__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.srv._apply_planning_scene.ApplyPlanningScene_Response", full_classname_dest, 65) == 0);
  }
...
bool moveit_msgs__srv__apply_planning_scene__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.srv._apply_planning_scene.ApplyPlanningScene_Event", full_classname_dest, 62) == 0);
  }
