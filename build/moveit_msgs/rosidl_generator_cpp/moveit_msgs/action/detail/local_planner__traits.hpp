  ...
  std::ostream & out)
{
  ...
  // member: local_constraints
  {
    if (msg.local_constraints.size() == 0) {
      ...
      out << "local_constraints: [";
      size_t pending_items = msg.local_constraints.size();
...
inline std::string to_yaml(const LocalPlanner_Goal & msg, bool use_flow_style = false)
{
...
inline std::string to_yaml(const LocalPlanner_Result & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
inline void to_flow_style_yaml(
  const LocalPlanner_Feedback & msg,
  std::ostream & out)
{
  out << "{";
  // member: feedback
...
inline std::string to_yaml(const LocalPlanner_Feedback & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
inline void to_flow_style_yaml(
  const LocalPlanner_SendGoal_Request & msg,
  std::ostream & out)
{
  out << "{";
  // member: goal_id
...
inline std::string to_yaml(const LocalPlanner_SendGoal_Request & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
inline void to_flow_style_yaml(
  const LocalPlanner_SendGoal_Response & msg,
  std::ostream & out)
{
  out << "{";
  // member: accepted
...
inline std::string to_yaml(const LocalPlanner_SendGoal_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
inline void to_flow_style_yaml(
  const LocalPlanner_SendGoal_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const LocalPlanner_SendGoal_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use moveit_msgs::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const moveit_msgs::action::LocalPlanner_SendGoal_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  moveit_msgs::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use moveit_msgs::action::to_yaml() instead")]]
inline std::string to_yaml(const moveit_msgs::action::LocalPlanner_SendGoal_Event & msg)
{
  return moveit_msgs::action::to_yaml(msg);
}

template<>
inline const char * data_type<moveit_msgs::action::LocalPlanner_SendGoal_Event>()
{
  return "moveit_msgs::action::LocalPlanner_SendGoal_Event";
}

template<>
inline const char * name<moveit_msgs::action::LocalPlanner_SendGoal_Event>()
{
  return "moveit_msgs/action/LocalPlanner_SendGoal_Event";
}

template<>
struct has_fixed_size<moveit_msgs::action::LocalPlanner_SendGoal_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<moveit_msgs::action::LocalPlanner_SendGoal_Event>
  : std::integral_constant<bool, has_bounded_size<moveit_msgs::action::LocalPlanner_SendGoal_Request>::value && has_bounded_size<moveit_msgs::action::LocalPlanner_SendGoal_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<moveit_msgs::action::LocalPlanner_SendGoal_Event>
  : std::true_type {};
...
inline void to_flow_style_yaml(
  const LocalPlanner_GetResult_Request & msg,
  std::ostream & out)
{
  out << "{";
  // member: goal_id
...
inline std::string to_yaml(const LocalPlanner_GetResult_Request & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
inline void to_flow_style_yaml(
  const LocalPlanner_GetResult_Response & msg,
  std::ostream & out)
{
  out << "{";
  // member: status
...
inline std::string to_yaml(const LocalPlanner_GetResult_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
inline void to_flow_style_yaml(
  const LocalPlanner_GetResult_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const LocalPlanner_GetResult_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use moveit_msgs::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const moveit_msgs::action::LocalPlanner_GetResult_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  moveit_msgs::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use moveit_msgs::action::to_yaml() instead")]]
inline std::string to_yaml(const moveit_msgs::action::LocalPlanner_GetResult_Event & msg)
{
  return moveit_msgs::action::to_yaml(msg);
}

template<>
inline const char * data_type<moveit_msgs::action::LocalPlanner_GetResult_Event>()
{
  return "moveit_msgs::action::LocalPlanner_GetResult_Event";
}

template<>
inline const char * name<moveit_msgs::action::LocalPlanner_GetResult_Event>()
{
  return "moveit_msgs/action/LocalPlanner_GetResult_Event";
}

template<>
struct has_fixed_size<moveit_msgs::action::LocalPlanner_GetResult_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<moveit_msgs::action::LocalPlanner_GetResult_Event>
  : std::integral_constant<bool, has_bounded_size<moveit_msgs::action::LocalPlanner_GetResult_Request>::value && has_bounded_size<moveit_msgs::action::LocalPlanner_GetResult_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<moveit_msgs::action::LocalPlanner_GetResult_Event>
  : std::true_type {};
...
inline void to_flow_style_yaml(
  const LocalPlanner_FeedbackMessage & msg,
  std::ostream & out)
{
  out << "{";
  // member: goal_id
...
inline std::string to_yaml(const LocalPlanner_FeedbackMessage & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
