...
bool cdr_serialize_moveit_msgs__srv__GetPositionIK_Request(
  const moveit_msgs__srv__GetPositionIK_Request * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: ik_request
  {
    cdr_serialize_moveit_msgs__msg__PositionIKRequest(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_moveit_msgs
bool cdr_deserialize_moveit_msgs__srv__GetPositionIK_Request(
  eprosima::fastcdr::Cdr & cdr,
  moveit_msgs__srv__GetPositionIK_Request * ros_message)
{
  // Field name: ik_request
  {
    cdr_deserialize_moveit_msgs__msg__PositionIKRequest(cdr, &ros_message->ik_request);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_moveit_msgs
bool cdr_serialize_key_moveit_msgs__srv__GetPositionIK_Request(
  const moveit_msgs__srv__GetPositionIK_Request * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: ik_request
  {
    cdr_serialize_key_moveit_msgs__msg__PositionIKRequest(
      &ros_message->ik_request, cdr);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_moveit_msgs
size_t get_serialized_size_key_moveit_msgs__srv__GetPositionIK_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetPositionIK_Request__ros_msg_type * ros_message = static_cast<const _GetPositionIK_Request__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: ik_request
  current_alignment += get_serialized_size_key_moveit_msgs__msg__PositionIKRequest(
    &(ros_message->ik_request), current_alignment);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_moveit_msgs
size_t max_serialized_size_key_moveit_msgs__srv__GetPositionIK_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: ik_request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_moveit_msgs__msg__PositionIKRequest(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const moveit_msgs__srv__GetPositionIK_Request * ros_message = static_cast<const moveit_msgs__srv__GetPositionIK_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_moveit_msgs__srv__GetPositionIK_Request(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  moveit_msgs__srv__GetPositionIK_Request * ros_message = static_cast<moveit_msgs__srv__GetPositionIK_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_moveit_msgs__srv__GetPositionIK_Request(cdr, ros_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_moveit_msgs
bool cdr_serialize_moveit_msgs__srv__GetPositionIK_Response(
  const moveit_msgs__srv__GetPositionIK_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: solution
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_moveit_msgs
bool cdr_deserialize_moveit_msgs__srv__GetPositionIK_Response(
  eprosima::fastcdr::Cdr & cdr,
  moveit_msgs__srv__GetPositionIK_Response * ros_message)
{
  // Field name: solution
  {
    cdr_deserialize_moveit_msgs__msg__RobotState(cdr, &ros_message->solution);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_moveit_msgs
bool cdr_serialize_key_moveit_msgs__srv__GetPositionIK_Response(
  const moveit_msgs__srv__GetPositionIK_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: solution
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_moveit_msgs
size_t get_serialized_size_key_moveit_msgs__srv__GetPositionIK_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetPositionIK_Response__ros_msg_type * ros_message = static_cast<const _GetPositionIK_Response__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_moveit_msgs
size_t max_serialized_size_key_moveit_msgs__srv__GetPositionIK_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const moveit_msgs__srv__GetPositionIK_Response * ros_message = static_cast<const moveit_msgs__srv__GetPositionIK_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_moveit_msgs__srv__GetPositionIK_Response(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  moveit_msgs__srv__GetPositionIK_Response * ros_message = static_cast<moveit_msgs__srv__GetPositionIK_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_moveit_msgs__srv__GetPositionIK_Response(cdr, ros_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_moveit_msgs
bool cdr_serialize_moveit_msgs__srv__GetPositionIK_Event(
  const moveit_msgs__srv__GetPositionIK_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_moveit_msgs__srv__GetPositionIK_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_moveit_msgs__srv__GetPositionIK_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_moveit_msgs
bool cdr_deserialize_moveit_msgs__srv__GetPositionIK_Event(
  eprosima::fastcdr::Cdr & cdr,
  moveit_msgs__srv__GetPositionIK_Event * ros_message)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    auto array_ptr = ros_message->request.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_moveit_msgs__srv__GetPositionIK_Request(cdr, &array_ptr[i]);
    }
  }
  ...
  // Field name: response
  {
    ...
    auto array_ptr = ros_message->response.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_moveit_msgs__srv__GetPositionIK_Response(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_moveit_msgs
bool cdr_serialize_key_moveit_msgs__srv__GetPositionIK_Event(
  const moveit_msgs__srv__GetPositionIK_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_moveit_msgs__srv__GetPositionIK_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_moveit_msgs__srv__GetPositionIK_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_moveit_msgs
size_t get_serialized_size_key_moveit_msgs__srv__GetPositionIK_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetPositionIK_Event__ros_msg_type * ros_message = static_cast<const _GetPositionIK_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_moveit_msgs__srv__GetPositionIK_Request(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_moveit_msgs__srv__GetPositionIK_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_moveit_msgs
size_t max_serialized_size_key_moveit_msgs__srv__GetPositionIK_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_moveit_msgs__srv__GetPositionIK_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_moveit_msgs__srv__GetPositionIK_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const moveit_msgs__srv__GetPositionIK_Event * ros_message = static_cast<const moveit_msgs__srv__GetPositionIK_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_moveit_msgs__srv__GetPositionIK_Event(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  moveit_msgs__srv__GetPositionIK_Event * ros_message = static_cast<moveit_msgs__srv__GetPositionIK_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_moveit_msgs__srv__GetPositionIK_Event(cdr, ros_message);
}
