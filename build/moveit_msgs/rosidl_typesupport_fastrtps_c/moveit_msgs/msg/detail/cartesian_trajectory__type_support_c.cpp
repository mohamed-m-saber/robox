...
#include "moveit_msgs/msg/detail/cartesian_trajectory__rosidl_typesupport_fastrtps_c.h"
...
#include "moveit_msgs/msg/detail/cartesian_trajectory_point__functions.h"  // points
#include "rosidl_runtime_c/string.h"  // tracked_frame
#include "rosidl_runtime_c/string_functions.h"  // tracked_frame
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: points
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_moveit_msgs__msg__CartesianTrajectoryPoint(
        &array_ptr[i], cdr);
    }
  }
  ...
  moveit_msgs__msg__CartesianTrajectory * ros_message)
{
  ...
  // Field name: points
  {
    ...
    auto array_ptr = ros_message->points.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_moveit_msgs__msg__CartesianTrajectoryPoint(cdr, &array_ptr[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = moveit_msgs__msg__CartesianTrajectory;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: points
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_moveit_msgs__msg__CartesianTrajectoryPoint(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: points
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_moveit_msgs__msg__CartesianTrajectoryPoint(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_moveit_msgs__msg__CartesianTrajectoryPoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const moveit_msgs__msg__CartesianTrajectory * ros_message = static_cast<const moveit_msgs__msg__CartesianTrajectory *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_moveit_msgs__msg__CartesianTrajectory(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  moveit_msgs__msg__CartesianTrajectory * ros_message = static_cast<moveit_msgs__msg__CartesianTrajectory *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_moveit_msgs__msg__CartesianTrajectory(cdr, ros_message);
}
...
static size_t _CartesianTrajectory__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_moveit_msgs__msg__CartesianTrajectory(
...
static rosidl_message_type_support_t _CartesianTrajectory__type_support = {
  ...
  &moveit_msgs__msg__CartesianTrajectory__get_type_hash,
  &moveit_msgs__msg__CartesianTrajectory__get_type_description,
  &moveit_msgs__msg__CartesianTrajectory__get_type_description_sources,
};
