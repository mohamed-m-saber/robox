...
#include "moveit_msgs/msg/detail/robot_state__rosidl_typesupport_fastrtps_c.h"
...
#include "moveit_msgs/msg/detail/attached_collision_object__functions.h"  // attached_collision_objects
#include "sensor_msgs/msg/detail/joint_state__functions.h"  // joint_state
#include "sensor_msgs/msg/detail/multi_dof_joint_state__functions.h"  // multi_dof_joint_state
...
using _RobotState__ros_msg_type = moveit_msgs__msg__RobotState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: multi_dof_joint_state
  {
    cdr_serialize_sensor_msgs__msg__MultiDOFJointState(
      &ros_message->multi_dof_joint_state, cdr);
  }

  // Field name: attached_collision_objects
  {
    size_t size = ros_message->attached_collision_objects.size;
    auto array_ptr = ros_message->attached_collision_objects.data;
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_moveit_msgs__msg__AttachedCollisionObject(
        &array_ptr[i], cdr);
    }
  }
  ...
  moveit_msgs__msg__RobotState * ros_message)
{
  ...
  // Field name: multi_dof_joint_state
  {
    cdr_deserialize_sensor_msgs__msg__MultiDOFJointState(cdr, &ros_message->multi_dof_joint_state);
  }
  ...
  // Field name: attached_collision_objects
  {
    ...
    if (ros_message->attached_collision_objects.data) {
      moveit_msgs__msg__AttachedCollisionObject__Sequence__fini(&ros_message->attached_collision_objects);
    }
    if (!moveit_msgs__msg__AttachedCollisionObject__Sequence__init(&ros_message->attached_collision_objects, size)) {
      fprintf(stderr, "failed to create array for field 'attached_collision_objects'");
      return false;
    }
    auto array_ptr = ros_message->attached_collision_objects.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_moveit_msgs__msg__AttachedCollisionObject(cdr, &array_ptr[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: multi_dof_joint_state
  current_alignment += get_serialized_size_sensor_msgs__msg__MultiDOFJointState(
  ...
  size_t current_alignment)
{
  ...
  // Field name: multi_dof_joint_state
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_sensor_msgs__msg__MultiDOFJointState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = moveit_msgs__msg__RobotState;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: multi_dof_joint_state
  {
    cdr_serialize_key_sensor_msgs__msg__MultiDOFJointState(
      &ros_message->multi_dof_joint_state, cdr);
  }
  ...
  // Field name: attached_collision_objects
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_moveit_msgs__msg__AttachedCollisionObject(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: multi_dof_joint_state
  current_alignment += get_serialized_size_key_sensor_msgs__msg__MultiDOFJointState(
    &(ros_message->multi_dof_joint_state), current_alignment);
  ...
  // Field name: attached_collision_objects
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_moveit_msgs__msg__AttachedCollisionObject(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: multi_dof_joint_state
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_sensor_msgs__msg__MultiDOFJointState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: attached_collision_objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_moveit_msgs__msg__AttachedCollisionObject(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const moveit_msgs__msg__RobotState * ros_message = static_cast<const moveit_msgs__msg__RobotState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_moveit_msgs__msg__RobotState(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  moveit_msgs__msg__RobotState * ros_message = static_cast<moveit_msgs__msg__RobotState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_moveit_msgs__msg__RobotState(cdr, ros_message);
}

static uint32_t _RobotState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_moveit_msgs__msg__RobotState(
...
static size_t _RobotState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_moveit_msgs__msg__RobotState(
