...
bool cdr_serialize_moveit_msgs__msg__DisplayTrajectory(
  const moveit_msgs__msg__DisplayTrajectory * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: model_id
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_moveit_msgs
bool cdr_deserialize_moveit_msgs__msg__DisplayTrajectory(
  eprosima::fastcdr::Cdr & cdr,
  moveit_msgs__msg__DisplayTrajectory * ros_message)
{
  // Field name: model_id
  {
    std::string tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = moveit_msgs__msg__DisplayTrajectory;
    is_plain =
      (
      offsetof(DataType, trajectory_start) +
      last_member_size
      ) == ret_val;
  }
  return ret_val;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_moveit_msgs
bool cdr_serialize_key_moveit_msgs__msg__DisplayTrajectory(
  const moveit_msgs__msg__DisplayTrajectory * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: model_id
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_moveit_msgs
size_t get_serialized_size_key_moveit_msgs__msg__DisplayTrajectory(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DisplayTrajectory__ros_msg_type * ros_message = static_cast<const _DisplayTrajectory__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_moveit_msgs
size_t max_serialized_size_key_moveit_msgs__msg__DisplayTrajectory(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const moveit_msgs__msg__DisplayTrajectory * ros_message = static_cast<const moveit_msgs__msg__DisplayTrajectory *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_moveit_msgs__msg__DisplayTrajectory(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  moveit_msgs__msg__DisplayTrajectory * ros_message = static_cast<moveit_msgs__msg__DisplayTrajectory *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_moveit_msgs__msg__DisplayTrajectory(cdr, ros_message);
}
...
static size_t _DisplayTrajectory__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_moveit_msgs__msg__DisplayTrajectory(
