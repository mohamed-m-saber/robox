...
#include "moveit_msgs/msg/detail/bounding_volume__rosidl_typesupport_fastrtps_c.h"
...
using _BoundingVolume__ros_msg_type = moveit_msgs__msg__BoundingVolume;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_moveit_msgs
bool cdr_serialize_moveit_msgs__msg__BoundingVolume(
  const moveit_msgs__msg__BoundingVolume * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_moveit_msgs
bool cdr_deserialize_moveit_msgs__msg__BoundingVolume(
  eprosima::fastcdr::Cdr & cdr,
  moveit_msgs__msg__BoundingVolume * ros_message)
{
  // Field name: primitives
  {
    uint32_t cdrSize;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_moveit_msgs
size_t get_serialized_size_moveit_msgs__msg__BoundingVolume(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _BoundingVolume__ros_msg_type * ros_message = static_cast<const _BoundingVolume__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_moveit_msgs
size_t max_serialized_size_moveit_msgs__msg__BoundingVolume(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = moveit_msgs__msg__BoundingVolume;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_moveit_msgs
bool cdr_serialize_key_moveit_msgs__msg__BoundingVolume(
  const moveit_msgs__msg__BoundingVolume * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: primitives
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_moveit_msgs
size_t get_serialized_size_key_moveit_msgs__msg__BoundingVolume(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _BoundingVolume__ros_msg_type * ros_message = static_cast<const _BoundingVolume__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_moveit_msgs
size_t max_serialized_size_key_moveit_msgs__msg__BoundingVolume(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const moveit_msgs__msg__BoundingVolume * ros_message = static_cast<const moveit_msgs__msg__BoundingVolume *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_moveit_msgs__msg__BoundingVolume(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  moveit_msgs__msg__BoundingVolume * ros_message = static_cast<moveit_msgs__msg__BoundingVolume *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_moveit_msgs__msg__BoundingVolume(cdr, ros_message);
}

static uint32_t _BoundingVolume__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_moveit_msgs__msg__BoundingVolume(
...
static size_t _BoundingVolume__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_moveit_msgs__msg__BoundingVolume(
...
static message_type_support_callbacks_t __callbacks_BoundingVolume = {
  "moveit_msgs::msg",
  "BoundingVolume",
...
static rosidl_message_type_support_t _BoundingVolume__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_BoundingVolume,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, moveit_msgs, msg, BoundingVolume)() {
  return &_BoundingVolume__type_support;
}
