...
bool cdr_serialize_moveit_msgs__msg__AllowedCollisionEntry(
  const moveit_msgs__msg__AllowedCollisionEntry * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_moveit_msgs__msg__AllowedCollisionEntry(
  eprosima::fastcdr::Cdr & cdr,
  moveit_msgs__msg__AllowedCollisionEntry * ros_message);
...
bool cdr_serialize_key_moveit_msgs__msg__AllowedCollisionEntry(
  const moveit_msgs__msg__AllowedCollisionEntry * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_moveit_msgs__msg__AllowedCollisionEntry(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_moveit_msgs__msg__AllowedCollisionEntry(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: entry_values
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_moveit_msgs__msg__AllowedCollisionEntry(
        &array_ptr[i], cdr);
    }
  }
  ...
  moveit_msgs__msg__AllowedCollisionMatrix * ros_message)
{
  ...
  // Field name: entry_values
  {
    ...
    auto array_ptr = ros_message->entry_values.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_moveit_msgs__msg__AllowedCollisionEntry(cdr, &array_ptr[i]);
    }
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: entry_values
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_moveit_msgs__msg__AllowedCollisionEntry(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: entry_values
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_moveit_msgs__msg__AllowedCollisionEntry(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: entry_values
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_moveit_msgs__msg__AllowedCollisionEntry(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const moveit_msgs__msg__AllowedCollisionMatrix * ros_message = static_cast<const moveit_msgs__msg__AllowedCollisionMatrix *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_moveit_msgs__msg__AllowedCollisionMatrix(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  moveit_msgs__msg__AllowedCollisionMatrix * ros_message = static_cast<moveit_msgs__msg__AllowedCollisionMatrix *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_moveit_msgs__msg__AllowedCollisionMatrix(cdr, ros_message);
}
