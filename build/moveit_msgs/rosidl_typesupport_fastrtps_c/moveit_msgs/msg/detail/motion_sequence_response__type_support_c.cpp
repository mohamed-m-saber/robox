  ...
  moveit_msgs__msg__MotionSequenceResponse * ros_message)
{
  ...
  // Field name: sequence_start
  {
    cdr_deserialize_moveit_msgs__msg__RobotState(cdr, &ros_message->sequence_start);
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const moveit_msgs__msg__MotionSequenceResponse * ros_message = static_cast<const moveit_msgs__msg__MotionSequenceResponse *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_moveit_msgs__msg__MotionSequenceResponse(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  moveit_msgs__msg__MotionSequenceResponse * ros_message = static_cast<moveit_msgs__msg__MotionSequenceResponse *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_moveit_msgs__msg__MotionSequenceResponse(cdr, ros_message);
}
