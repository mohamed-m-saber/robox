...
#include "moveit_msgs/msg/detail/place_location__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/pose_stamped__functions.h"  // place_pose
#include "moveit_msgs/msg/detail/gripper_translation__functions.h"  // post_place_retreat, pre_place_approach
...
#include "trajectory_msgs/msg/detail/joint_trajectory__functions.h"  // post_place_posture
...
using _PlaceLocation__ros_msg_type = moveit_msgs__msg__PlaceLocation;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: post_place_posture
  {
    cdr_serialize_trajectory_msgs__msg__JointTrajectory(
      &ros_message->post_place_posture, cdr);
  }
  ...
  // Field name: pre_place_approach
  {
    cdr_serialize_moveit_msgs__msg__GripperTranslation(
      &ros_message->pre_place_approach, cdr);
  }
  ...
  moveit_msgs__msg__PlaceLocation * ros_message)
{
  ...
  // Field name: post_place_posture
  {
    cdr_deserialize_trajectory_msgs__msg__JointTrajectory(cdr, &ros_message->post_place_posture);
  }
  ...
  // Field name: pre_place_approach
  {
    cdr_deserialize_moveit_msgs__msg__GripperTranslation(cdr, &ros_message->pre_place_approach);
  }
...
size_t get_serialized_size_moveit_msgs__msg__PlaceLocation(
  ...
  size_t current_alignment)
{
  const _PlaceLocation__ros_msg_type * ros_message = static_cast<const _PlaceLocation__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = moveit_msgs__msg__PlaceLocation;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const moveit_msgs__msg__PlaceLocation * ros_message = static_cast<const moveit_msgs__msg__PlaceLocation *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_moveit_msgs__msg__PlaceLocation(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  moveit_msgs__msg__PlaceLocation * ros_message = static_cast<moveit_msgs__msg__PlaceLocation *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_moveit_msgs__msg__PlaceLocation(cdr, ros_message);
}

static uint32_t _PlaceLocation__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_moveit_msgs__msg__PlaceLocation(
...
static size_t _PlaceLocation__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_moveit_msgs__msg__PlaceLocation(
...
static message_type_support_callbacks_t __callbacks_PlaceLocation = {
  "moveit_msgs::msg",
  "PlaceLocation",
...
static rosidl_message_type_support_t _PlaceLocation__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_PlaceLocation,
  get_message_typesupport_handle_function,
  &moveit_msgs__msg__PlaceLocation__get_type_hash,
  &moveit_msgs__msg__PlaceLocation__get_type_description,
  &moveit_msgs__msg__PlaceLocation__get_type_description_sources,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, moveit_msgs, msg, PlaceLocation)() {
  return &_PlaceLocation__type_support;
}
