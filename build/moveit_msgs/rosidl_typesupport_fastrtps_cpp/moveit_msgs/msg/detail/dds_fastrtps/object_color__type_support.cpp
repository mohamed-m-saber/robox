...
#include "moveit_msgs/msg/detail/object_color__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const moveit_msgs::msg::ObjectColor & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  moveit_msgs::msg::ObjectColor & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = moveit_msgs::msg::ObjectColor;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_moveit_msgs
max_serialized_size_key_ObjectColor(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const moveit_msgs::msg::ObjectColor *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<moveit_msgs::msg::ObjectColor *>(
    untyped_ros_message);
...
get_message_type_support_handle<moveit_msgs::msg::ObjectColor>()
{
  return &moveit_msgs::msg::typesupport_fastrtps_cpp::_ObjectColor__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, moveit_msgs, msg, ObjectColor)() {
  return &moveit_msgs::msg::typesupport_fastrtps_cpp::_ObjectColor__handle;
}
