...
#include "moveit_msgs/msg/detail/attached_collision_object__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const moveit_msgs::msg::AttachedCollisionObject & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  moveit_msgs::msg::AttachedCollisionObject & ros_message)
{
  // Member: link_name
  cdr >> ros_message.link_name;
  ...
  size_t current_alignment)
{
  ...
  // Member: touch_links
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += padding +
        eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
        (ros_message.touch_links[index].size() + 1);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = moveit_msgs::msg::AttachedCollisionObject;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const moveit_msgs::msg::AttachedCollisionObject *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<moveit_msgs::msg::AttachedCollisionObject *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _AttachedCollisionObject__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const moveit_msgs::msg::AttachedCollisionObject *>(
...
static size_t _AttachedCollisionObject__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_AttachedCollisionObject(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _AttachedCollisionObject__callbacks = {
  "moveit_msgs::msg",
...
static rosidl_message_type_support_t _AttachedCollisionObject__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_AttachedCollisionObject__callbacks,
...
{
  return &moveit_msgs::msg::typesupport_fastrtps_cpp::_AttachedCollisionObject__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, moveit_msgs, msg, AttachedCollisionObject)() {
  return &moveit_msgs::msg::typesupport_fastrtps_cpp::_AttachedCollisionObject__handle;
}
