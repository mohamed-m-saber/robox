...
#include "moveit_msgs/msg/detail/cartesian_trajectory__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const moveit_msgs::msg::CartesianTrajectory & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  moveit_msgs::msg::CartesianTrajectory & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = moveit_msgs::msg::CartesianTrajectory;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        moveit_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_CartesianTrajectoryPoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const moveit_msgs::msg::CartesianTrajectory *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<moveit_msgs::msg::CartesianTrajectory *>(
    untyped_ros_message);
...
get_message_type_support_handle<moveit_msgs::msg::CartesianTrajectory>()
{
  return &moveit_msgs::msg::typesupport_fastrtps_cpp::_CartesianTrajectory__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, moveit_msgs, msg, CartesianTrajectory)() {
  return &moveit_msgs::msg::typesupport_fastrtps_cpp::_CartesianTrajectory__handle;
}
