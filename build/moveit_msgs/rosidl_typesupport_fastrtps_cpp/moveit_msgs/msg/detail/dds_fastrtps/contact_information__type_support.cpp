...
#include "moveit_msgs/msg/detail/contact_information__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const moveit_msgs::msg::ContactInformation & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  cdr << ros_message.contact_body_1;

  // Member: body_type_1
  cdr << ros_message.body_type_1;

  // Member: contact_body_2
  cdr << ros_message.contact_body_2;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  moveit_msgs::msg::ContactInformation & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = moveit_msgs::msg::ContactInformation;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const moveit_msgs::msg::ContactInformation *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<moveit_msgs::msg::ContactInformation *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ContactInformation__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const moveit_msgs::msg::ContactInformation *>(
...
static size_t _ContactInformation__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ContactInformation(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ContactInformation__callbacks = {
  "moveit_msgs::msg",
  "ContactInformation",
...
static rosidl_message_type_support_t _ContactInformation__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ContactInformation__callbacks,
...
get_message_type_support_handle<moveit_msgs::msg::ContactInformation>()
{
  return &moveit_msgs::msg::typesupport_fastrtps_cpp::_ContactInformation__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, moveit_msgs, msg, ContactInformation)() {
  return &moveit_msgs::msg::typesupport_fastrtps_cpp::_ContactInformation__handle;
}
