...
size_t get_serialized_size_key(
  ...
  size_t current_alignment);
size_t
max_serialized_size_key_MotionSequenceItem(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = moveit_msgs::msg::MotionSequenceRequest;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: items
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        moveit_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_MotionSequenceItem(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
static size_t _MotionSequenceRequest__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MotionSequenceRequest(full_bounded, is_plain, 0);
