...
#include "moveit_msgs/msg/detail/planning_options__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = moveit_msgs::msg::PlanningOptions;
    is_plain =
      (
...
static size_t _PlanningOptions__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PlanningOptions(full_bounded, is_plain, 0);
