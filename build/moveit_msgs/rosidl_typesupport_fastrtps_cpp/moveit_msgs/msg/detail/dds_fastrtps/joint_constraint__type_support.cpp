...
#include "moveit_msgs/msg/detail/joint_constraint__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const moveit_msgs::msg::JointConstraint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  moveit_msgs::msg::JointConstraint & ros_message)
{
  // Member: joint_name
  cdr >> ros_message.joint_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = moveit_msgs::msg::JointConstraint;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_moveit_msgs
max_serialized_size_key_JointConstraint(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const moveit_msgs::msg::JointConstraint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<moveit_msgs::msg::JointConstraint *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _JointConstraint__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const moveit_msgs::msg::JointConstraint *>(
...
static size_t _JointConstraint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_JointConstraint(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _JointConstraint__callbacks = {
  "moveit_msgs::msg",
  "JointConstraint",
...
static rosidl_message_type_support_t _JointConstraint__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_JointConstraint__callbacks,
...
get_message_type_support_handle<moveit_msgs::msg::JointConstraint>()
{
  return &moveit_msgs::msg::typesupport_fastrtps_cpp::_JointConstraint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, moveit_msgs, msg, JointConstraint)() {
  return &moveit_msgs::msg::typesupport_fastrtps_cpp::_JointConstraint__handle;
}
