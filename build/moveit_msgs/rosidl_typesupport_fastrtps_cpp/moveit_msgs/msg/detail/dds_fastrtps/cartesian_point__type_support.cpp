...
#include "moveit_msgs/msg/detail/cartesian_point__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const moveit_msgs::msg::CartesianPoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  moveit_msgs::msg::CartesianPoint & ros_message)
{
  // Member: pose
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = moveit_msgs::msg::CartesianPoint;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_moveit_msgs
max_serialized_size_key_CartesianPoint(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const moveit_msgs::msg::CartesianPoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<moveit_msgs::msg::CartesianPoint *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CartesianPoint__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const moveit_msgs::msg::CartesianPoint *>(
...
static size_t _CartesianPoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CartesianPoint(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CartesianPoint__callbacks = {
  "moveit_msgs::msg",
  "CartesianPoint",
...
static rosidl_message_type_support_t _CartesianPoint__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CartesianPoint__callbacks,
...
{
  return &moveit_msgs::msg::typesupport_fastrtps_cpp::_CartesianPoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, moveit_msgs, msg, CartesianPoint)() {
  return &moveit_msgs::msg::typesupport_fastrtps_cpp::_CartesianPoint__handle;
}
