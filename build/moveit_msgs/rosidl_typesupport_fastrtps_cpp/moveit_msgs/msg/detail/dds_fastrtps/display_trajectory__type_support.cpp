  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = moveit_msgs::msg::DisplayTrajectory;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_moveit_msgs
max_serialized_size_key_DisplayTrajectory(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _DisplayTrajectory__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DisplayTrajectory(full_bounded, is_plain, 0);
