...
#include "moveit_msgs/msg/detail/allowed_collision_entry__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const moveit_msgs::msg::AllowedCollisionEntry & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  moveit_msgs::msg::AllowedCollisionEntry & ros_message)
{
  // Member: enabled
  {
    cdr >> ros_message.enabled;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = moveit_msgs::msg::AllowedCollisionEntry;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_moveit_msgs
max_serialized_size_key_AllowedCollisionEntry(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const moveit_msgs::msg::AllowedCollisionEntry *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<moveit_msgs::msg::AllowedCollisionEntry *>(
    untyped_ros_message);
...
{
  return &moveit_msgs::msg::typesupport_fastrtps_cpp::_AllowedCollisionEntry__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, moveit_msgs, msg, AllowedCollisionEntry)() {
  return &moveit_msgs::msg::typesupport_fastrtps_cpp::_AllowedCollisionEntry__handle;
}
