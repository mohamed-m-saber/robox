...
#include "moveit_msgs/msg/detail/link_scale__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const moveit_msgs::msg::LinkScale & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  moveit_msgs::msg::LinkScale & ros_message)
{
  // Member: link_name
  cdr >> ros_message.link_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = moveit_msgs::msg::LinkScale;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_moveit_msgs
max_serialized_size_key_LinkScale(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const moveit_msgs::msg::LinkScale *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<moveit_msgs::msg::LinkScale *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LinkScale__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const moveit_msgs::msg::LinkScale *>(
...
static size_t _LinkScale__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_LinkScale(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _LinkScale__callbacks = {
  "moveit_msgs::msg",
  "LinkScale",
...
static rosidl_message_type_support_t _LinkScale__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LinkScale__callbacks,
...
{
  return &moveit_msgs::msg::typesupport_fastrtps_cpp::_LinkScale__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, moveit_msgs, msg, LinkScale)() {
  return &moveit_msgs::msg::typesupport_fastrtps_cpp::_LinkScale__handle;
}
