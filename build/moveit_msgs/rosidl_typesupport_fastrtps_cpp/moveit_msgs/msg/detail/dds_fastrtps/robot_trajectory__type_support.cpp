...
#include "moveit_msgs/msg/detail/robot_trajectory__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const moveit_msgs::msg::RobotTrajectory & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  trajectory_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.multi_dof_joint_trajectory,
    cdr);
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  moveit_msgs::msg::RobotTrajectory & ros_message)
{
  // Member: joint_trajectory
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = moveit_msgs::msg::RobotTrajectory;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<moveit_msgs::msg::RobotTrajectory *>(
    untyped_ros_message);
...
static size_t _RobotTrajectory__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RobotTrajectory(full_bounded, is_plain, 0);
...
{
  return &moveit_msgs::msg::typesupport_fastrtps_cpp::_RobotTrajectory__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, moveit_msgs, msg, RobotTrajectory)() {
  return &moveit_msgs::msg::typesupport_fastrtps_cpp::_RobotTrajectory__handle;
}
