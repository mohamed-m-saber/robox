...
#include "cube_msgs/msg/detail/color_pose_stamped__rosidl_typesupport_fastrtps_c.h"
...
using _ColorPoseStamped__ros_msg_type = cube_msgs__msg__ColorPoseStamped;
...
size_t get_serialized_size_cube_msgs__msg__ColorPoseStamped(
  ...
  size_t current_alignment)
{
  const _ColorPoseStamped__ros_msg_type * ros_message = static_cast<const _ColorPoseStamped__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cube_msgs__msg__ColorPoseStamped;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const cube_msgs__msg__ColorPoseStamped * ros_message = static_cast<const cube_msgs__msg__ColorPoseStamped *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_cube_msgs__msg__ColorPoseStamped(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  cube_msgs__msg__ColorPoseStamped * ros_message = static_cast<cube_msgs__msg__ColorPoseStamped *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_cube_msgs__msg__ColorPoseStamped(cdr, ros_message);
}

static uint32_t _ColorPoseStamped__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cube_msgs__msg__ColorPoseStamped(
...
static size_t _ColorPoseStamped__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cube_msgs__msg__ColorPoseStamped(
...
static message_type_support_callbacks_t __callbacks_ColorPoseStamped = {
  "cube_msgs::msg",
  "ColorPoseStamped",
...
static rosidl_message_type_support_t _ColorPoseStamped__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ColorPoseStamped,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cube_msgs, msg, ColorPoseStamped)() {
  return &_ColorPoseStamped__type_support;
}
