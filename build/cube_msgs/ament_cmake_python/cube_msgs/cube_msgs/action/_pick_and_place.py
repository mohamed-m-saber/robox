...
class Metaclass_PickAndPlace_Goal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('cube_msgs')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'cube_msgs.action.PickAndPlace_Goal')
            logger.debug(
...
class PickAndPlace_Goal(metaclass=Metaclass_PickAndPlace_Goal):
    ...
    def qr(self, value):
        if self._check_fields:
            assert \
                isinstance(value, str), \
                "The 'qr' field must be of type 'str'"
        self._qr = value
...
class Metaclass_PickAndPlace_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'cube_msgs.action.PickAndPlace_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_PickAndPlace_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'cube_msgs.action.PickAndPlace_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class PickAndPlace_SendGoal_Request(metaclass=Metaclass_PickAndPlace_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'cube_msgs/PickAndPlace_Goal',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['cube_msgs', 'action'], 'PickAndPlace_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from cube_msgs.action._pick_and_place import PickAndPlace_Goal
...
class PickAndPlace_SendGoal_Event(metaclass=Metaclass_PickAndPlace_SendGoal_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<cube_msgs/PickAndPlace_SendGoal_Request, 1>',
        'response': 'sequence<cube_msgs/PickAndPlace_SendGoal_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['cube_msgs', 'action'], 'PickAndPlace_SendGoal_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['cube_msgs', 'action'], 'PickAndPlace_SendGoal_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from cube_msgs.action import PickAndPlace_SendGoal_Request
    ...
    def response(self, value):
        if self._check_fields:
            from cube_msgs.action import PickAndPlace_SendGoal_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_PickAndPlace_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'cube_msgs.action.PickAndPlace_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from cube_msgs.action import _pick_and_place
...
class PickAndPlace_SendGoal(metaclass=Metaclass_PickAndPlace_SendGoal):
    from cube_msgs.action._pick_and_place import PickAndPlace_SendGoal_Request as Request
    from cube_msgs.action._pick_and_place import PickAndPlace_SendGoal_Response as Response
    from cube_msgs.action._pick_and_place import PickAndPlace_SendGoal_Event as Event
...
class PickAndPlace_GetResult_Response(metaclass=Metaclass_PickAndPlace_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'cube_msgs/PickAndPlace_Result',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['cube_msgs', 'action'], 'PickAndPlace_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from cube_msgs.action._pick_and_place import PickAndPlace_Result
...
class PickAndPlace_GetResult_Event(metaclass=Metaclass_PickAndPlace_GetResult_Event):
    ...
    _fields_and_field_types = {
        'info': 'service_msgs/ServiceEventInfo',
        'request': 'sequence<cube_msgs/PickAndPlace_GetResult_Request, 1>',
        'response': 'sequence<cube_msgs/PickAndPlace_GetResult_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['service_msgs', 'msg'], 'ServiceEventInfo'),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['cube_msgs', 'action'], 'PickAndPlace_GetResult_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['cube_msgs', 'action'], 'PickAndPlace_GetResult_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from cube_msgs.action import PickAndPlace_GetResult_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
    ...
    def response(self, value):
        if self._check_fields:
            from cube_msgs.action import PickAndPlace_GetResult_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_PickAndPlace_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'cube_msgs.action.PickAndPlace_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class PickAndPlace_GetResult(metaclass=Metaclass_PickAndPlace_GetResult):
    from cube_msgs.action._pick_and_place import PickAndPlace_GetResult_Request as Request
    from cube_msgs.action._pick_and_place import PickAndPlace_GetResult_Response as Response
    from cube_msgs.action._pick_and_place import PickAndPlace_GetResult_Event as Event
...
class Metaclass_PickAndPlace_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'cube_msgs.action.PickAndPlace_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class PickAndPlace_FeedbackMessage(metaclass=Metaclass_PickAndPlace_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'cube_msgs/PickAndPlace_Feedback',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['cube_msgs', 'action'], 'PickAndPlace_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from cube_msgs.action._pick_and_place import PickAndPlace_Feedback
...
class PickAndPlace(metaclass=Metaclass_PickAndPlace):
    ...
    from cube_msgs.action._pick_and_place import PickAndPlace_Goal as Goal
    # The result message defined in the action definition.
    from cube_msgs.action._pick_and_place import PickAndPlace_Result as Result
    # The feedback message defined in the action definition.
    from cube_msgs.action._pick_and_place import PickAndPlace_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from cube_msgs.action._pick_and_place import PickAndPlace_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from cube_msgs.action._pick_and_place import PickAndPlace_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from cube_msgs.action._pick_and_place import PickAndPlace_FeedbackMessage as FeedbackMessage
