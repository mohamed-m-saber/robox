...
#include "cube_msgs/action/detail/pick_and_place__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const cube_msgs::action::PickAndPlace_Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cube_msgs::action::PickAndPlace_Goal & ros_message)
{
  // Member: target_pose
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cube_msgs::action::PickAndPlace_Goal;
    is_plain =
      (
      offsetof(DataType, qr) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const cube_msgs::action::PickAndPlace_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cube_msgs::action::PickAndPlace_Goal *>(
    untyped_ros_message);
...
{
  return &cube_msgs::action::typesupport_fastrtps_cpp::_PickAndPlace_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cube_msgs, action, PickAndPlace_Goal)() {
  return &cube_msgs::action::typesupport_fastrtps_cpp::_PickAndPlace_Goal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cube_msgs
cdr_serialize(
  const cube_msgs::action::PickAndPlace_Result & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cube_msgs::action::PickAndPlace_Result & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cube_msgs::action::PickAndPlace_Result;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cube_msgs::action::PickAndPlace_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<cube_msgs::action::PickAndPlace_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &cube_msgs::action::typesupport_fastrtps_cpp::_PickAndPlace_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cube_msgs, action, PickAndPlace_Result)() {
  return &cube_msgs::action::typesupport_fastrtps_cpp::_PickAndPlace_Result__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cube_msgs
cdr_serialize(
  const cube_msgs::action::PickAndPlace_Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cube_msgs::action::PickAndPlace_Feedback & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cube_msgs::action::PickAndPlace_Feedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cube_msgs::action::PickAndPlace_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<cube_msgs::action::PickAndPlace_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &cube_msgs::action::typesupport_fastrtps_cpp::_PickAndPlace_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cube_msgs, action, PickAndPlace_Feedback)() {
  return &cube_msgs::action::typesupport_fastrtps_cpp::_PickAndPlace_Feedback__handle;
}
...
// functions for cube_msgs::action::PickAndPlace_Goal already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cube_msgs
cdr_serialize(
  const cube_msgs::action::PickAndPlace_SendGoal_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  ...
  // Member: goal
  cube_msgs::action::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.goal,
    cdr);
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cube_msgs::action::PickAndPlace_SendGoal_Request & ros_message)
{
  // Member: goal_id
  ...
  // Member: goal
  cube_msgs::action::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  current_alignment +=
    cube_msgs::action::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        cube_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_PickAndPlace_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cube_msgs::action::PickAndPlace_SendGoal_Request;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: goal
  cube_msgs::action::typesupport_fastrtps_cpp::cdr_serialize_key(
    ros_message.goal,
    cdr);
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  current_alignment +=
    cube_msgs::action::typesupport_fastrtps_cpp::get_serialized_size_key(
    ros_message.goal, current_alignment);
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        cube_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_key_PickAndPlace_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const cube_msgs::action::PickAndPlace_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<cube_msgs::action::PickAndPlace_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &cube_msgs::action::typesupport_fastrtps_cpp::_PickAndPlace_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cube_msgs, action, PickAndPlace_SendGoal_Request)() {
  return &cube_msgs::action::typesupport_fastrtps_cpp::_PickAndPlace_SendGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cube_msgs
cdr_serialize(
  const cube_msgs::action::PickAndPlace_SendGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cube_msgs::action::PickAndPlace_SendGoal_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cube_msgs::action::PickAndPlace_SendGoal_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cube_msgs::action::PickAndPlace_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<cube_msgs::action::PickAndPlace_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &cube_msgs::action::typesupport_fastrtps_cpp::_PickAndPlace_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cube_msgs, action, PickAndPlace_SendGoal_Response)() {
  return &cube_msgs::action::typesupport_fastrtps_cpp::_PickAndPlace_SendGoal_Response__handle;
}
...
// functions for cube_msgs::action::PickAndPlace_SendGoal_Request already declared above

// functions for cube_msgs::action::PickAndPlace_SendGoal_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cube_msgs
cdr_serialize(
  const cube_msgs::action::PickAndPlace_SendGoal_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cube_msgs::action::PickAndPlace_SendGoal_Event & ros_message)
{
  // Member: info
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        cube_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_PickAndPlace_SendGoal_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        cube_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_PickAndPlace_SendGoal_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cube_msgs::action::PickAndPlace_SendGoal_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        cube_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_key_PickAndPlace_SendGoal_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        cube_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_key_PickAndPlace_SendGoal_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const cube_msgs::action::PickAndPlace_SendGoal_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<cube_msgs::action::PickAndPlace_SendGoal_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &cube_msgs::action::typesupport_fastrtps_cpp::_PickAndPlace_SendGoal_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cube_msgs, action, PickAndPlace_SendGoal_Event)() {
  return &cube_msgs::action::typesupport_fastrtps_cpp::_PickAndPlace_SendGoal_Event__handle;
}
...
static const rosidl_service_type_support_t _PickAndPlace_SendGoal__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<cube_msgs::action::PickAndPlace_SendGoal_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<cube_msgs::action::PickAndPlace_SendGoal_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<cube_msgs::action::PickAndPlace_SendGoal_Event>(),
...
{
  return &cube_msgs::action::typesupport_fastrtps_cpp::_PickAndPlace_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cube_msgs, action, PickAndPlace_SendGoal)() {
  return &cube_msgs::action::typesupport_fastrtps_cpp::_PickAndPlace_SendGoal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cube_msgs
cdr_serialize(
  const cube_msgs::action::PickAndPlace_GetResult_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cube_msgs::action::PickAndPlace_GetResult_Request & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cube_msgs::action::PickAndPlace_GetResult_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cube_msgs::action::PickAndPlace_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<cube_msgs::action::PickAndPlace_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &cube_msgs::action::typesupport_fastrtps_cpp::_PickAndPlace_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cube_msgs, action, PickAndPlace_GetResult_Request)() {
  return &cube_msgs::action::typesupport_fastrtps_cpp::_PickAndPlace_GetResult_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for cube_msgs::action::PickAndPlace_Result already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cube_msgs
cdr_serialize(
  const cube_msgs::action::PickAndPlace_GetResult_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
  cdr << ros_message.status;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cube_msgs::action::PickAndPlace_GetResult_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        cube_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_PickAndPlace_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cube_msgs::action::PickAndPlace_GetResult_Response;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        cube_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_key_PickAndPlace_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const cube_msgs::action::PickAndPlace_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<cube_msgs::action::PickAndPlace_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &cube_msgs::action::typesupport_fastrtps_cpp::_PickAndPlace_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cube_msgs, action, PickAndPlace_GetResult_Response)() {
  return &cube_msgs::action::typesupport_fastrtps_cpp::_PickAndPlace_GetResult_Response__handle;
}
...
// functions for cube_msgs::action::PickAndPlace_GetResult_Request already declared above

// functions for cube_msgs::action::PickAndPlace_GetResult_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cube_msgs
cdr_serialize(
  const cube_msgs::action::PickAndPlace_GetResult_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
  service_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cube_msgs::action::PickAndPlace_GetResult_Event & ros_message)
{
  // Member: info
  service_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.info);
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        cube_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_PickAndPlace_GetResult_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        cube_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_PickAndPlace_GetResult_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cube_msgs::action::PickAndPlace_GetResult_Event;
    is_plain =
      (
      offsetof(DataType, response) +
      last_member_size
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        cube_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_key_PickAndPlace_GetResult_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        cube_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_key_PickAndPlace_GetResult_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const cube_msgs::action::PickAndPlace_GetResult_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<cube_msgs::action::PickAndPlace_GetResult_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &cube_msgs::action::typesupport_fastrtps_cpp::_PickAndPlace_GetResult_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cube_msgs, action, PickAndPlace_GetResult_Event)() {
  return &cube_msgs::action::typesupport_fastrtps_cpp::_PickAndPlace_GetResult_Event__handle;
}
...
static const rosidl_service_type_support_t _PickAndPlace_GetResult__handle{
  ...
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<cube_msgs::action::PickAndPlace_GetResult_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<cube_msgs::action::PickAndPlace_GetResult_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<cube_msgs::action::PickAndPlace_GetResult_Event>(),
...
{
  return &cube_msgs::action::typesupport_fastrtps_cpp::_PickAndPlace_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cube_msgs, action, PickAndPlace_GetResult)() {
  return &cube_msgs::action::typesupport_fastrtps_cpp::_PickAndPlace_GetResult__handle;
}
...
// functions for cube_msgs::action::PickAndPlace_Feedback already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cube_msgs
cdr_serialize(
  const cube_msgs::action::PickAndPlace_FeedbackMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cube_msgs::action::PickAndPlace_FeedbackMessage & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        cube_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_PickAndPlace_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cube_msgs::action::PickAndPlace_FeedbackMessage;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        cube_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_key_PickAndPlace_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const cube_msgs::action::PickAndPlace_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<cube_msgs::action::PickAndPlace_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &cube_msgs::action::typesupport_fastrtps_cpp::_PickAndPlace_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cube_msgs, action, PickAndPlace_FeedbackMessage)() {
  return &cube_msgs::action::typesupport_fastrtps_cpp::_PickAndPlace_FeedbackMessage__handle;
}
