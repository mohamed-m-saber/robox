...
def detect_single_closest_cube(roi_frame, pixel_size_mm, offset_x, offset_y):
    ...
    color_priority = {'Red': 1, 'Blue': 2, 'Green': 3}
        ...
        for cnt in contours:
            ...
            if pose[0] is not None:
                ...
                detected_poses.append((
                    color_priority[color_name],  # priority for sorting
                    y,                           # image Y for proximity
                    x_mm, y_mm, theta_z, color_name
                ))
    ...
    _, _, x_mm, y_mm, theta_z, color_name = detected_poses[0]
