...
class Init_PickAndPlace_Goal_qr
{
public:
  explicit Init_PickAndPlace_Goal_qr(::cube_msgs::action::PickAndPlace_Goal & msg)
  : msg_(msg)
  {}
  ::cube_msgs::action::PickAndPlace_Goal qr(::cube_msgs::action::PickAndPlace_Goal::_qr_type arg)
  {
    msg_.qr = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_PickAndPlace_Goal_qr color(::cube_msgs::action::PickAndPlace_Goal::_color_type arg)
  {
    msg_.color = std::move(arg);
    return Init_PickAndPlace_Goal_qr(msg_);
  }
