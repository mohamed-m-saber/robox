...
: ${AMENT_CURRENT_PREFIX:="/home/saber/robox_ws/src/install/robox_moveit_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/robox_moveit_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/robox_moveit_config/environment/path.sh"
