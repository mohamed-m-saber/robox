...
static char moveit_msgs__msg__PlanningScene__FIELD_NAME__name[] = "name";
static char moveit_msgs__msg__PlanningScene__FIELD_NAME__robot_state[] = "robot_state";
static char moveit_msgs__msg__PlanningScene__FIELD_NAME__robot_model_name[] = "robot_model_name";
static char moveit_msgs__msg__PlanningScene__FIELD_NAME__fixed_frame_transforms[] = "fixed_frame_transforms";
static char moveit_msgs__msg__PlanningScene__FIELD_NAME__allowed_collision_matrix[] = "allowed_collision_matrix";
static char moveit_msgs__msg__PlanningScene__FIELD_NAME__link_padding[] = "link_padding";
static char moveit_msgs__msg__PlanningScene__FIELD_NAME__link_scale[] = "link_scale";
static char moveit_msgs__msg__PlanningScene__FIELD_NAME__object_colors[] = "object_colors";
static char moveit_msgs__msg__PlanningScene__FIELD_NAME__world[] = "world";
static char moveit_msgs__msg__PlanningScene__FIELD_NAME__is_diff[] = "is_diff";

static rosidl_runtime_c__type_description__Field moveit_msgs__msg__PlanningScene__FIELDS[] = {
  {
    {moveit_msgs__msg__PlanningScene__FIELD_NAME__name, 4, 4},
    {
  ...
  {
    {moveit_msgs__msg__PlanningScene__FIELD_NAME__robot_state, 11, 11},
    {
  ...
  {
    {moveit_msgs__msg__PlanningScene__FIELD_NAME__robot_model_name, 16, 16},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_STRING,
      0,
      0,
  ...
  {
    {moveit_msgs__msg__PlanningScene__FIELD_NAME__fixed_frame_transforms, 22, 22},
    {
  ...
  {
    {moveit_msgs__msg__PlanningScene__FIELD_NAME__allowed_collision_matrix, 24, 24},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {moveit_msgs__msg__PlanningScene__FIELD_NAME__link_padding, 12, 12},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE_UNBOUNDED_SEQUENCE,
      0,
      0,
  ...
  {
    {moveit_msgs__msg__PlanningScene__FIELD_NAME__link_scale, 10, 10},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE_UNBOUNDED_SEQUENCE,
      0,
      0,
  ...
  {
    {moveit_msgs__msg__PlanningScene__FIELD_NAME__object_colors, 13, 13},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE_UNBOUNDED_SEQUENCE,
      0,
      0,
  ...
  {
    {moveit_msgs__msg__PlanningScene__FIELD_NAME__world, 5, 5},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {moveit_msgs__msg__PlanningScene__FIELD_NAME__is_diff, 7, 7},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription moveit_msgs__msg__PlanningScene__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {moveit_msgs__msg__PlanningScene__FIELDS, 10, 10},
    },
    {moveit_msgs__msg__PlanningScene__REFERENCED_TYPE_DESCRIPTIONS, 34, 34},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[19].fields = moveit_msgs__msg__PlanningSceneWorld__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[22].fields = octomap_msgs__msg__Octomap__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[23].fields = octomap_msgs__msg__OctomapWithPose__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[26].fields = shape_msgs__msg__Mesh__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[27].fields = shape_msgs__msg__MeshTriangle__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[28].fields = shape_msgs__msg__Plane__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[29].fields = shape_msgs__msg__SolidPrimitive__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[30].fields = std_msgs__msg__ColorRGBA__get_type_description(NULL)->type_description.fields;
...
moveit_msgs__msg__PlanningScene__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  static const rosidl_runtime_c__type_description__TypeSource source = {
    {moveit_msgs__msg__PlanningScene__TYPE_NAME, 29, 29},
    {msg_encoding, 3, 3},
    {toplevel_type_raw_source, 783, 783},
  };
  return &source;
}
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *moveit_msgs__msg__PlanningScene__get_individual_type_description_source(NULL),
    ...
    sources[20] = *moveit_msgs__msg__PlanningSceneWorld__get_individual_type_description_source(NULL);
    ...
    sources[23] = *octomap_msgs__msg__Octomap__get_individual_type_description_source(NULL);
    sources[24] = *octomap_msgs__msg__OctomapWithPose__get_individual_type_description_source(NULL);
    ...
    sources[27] = *shape_msgs__msg__Mesh__get_individual_type_description_source(NULL);
    sources[28] = *shape_msgs__msg__MeshTriangle__get_individual_type_description_source(NULL);
    sources[29] = *shape_msgs__msg__Plane__get_individual_type_description_source(NULL);
    sources[30] = *shape_msgs__msg__SolidPrimitive__get_individual_type_description_source(NULL);
    sources[31] = *std_msgs__msg__ColorRGBA__get_individual_type_description_source(NULL);
