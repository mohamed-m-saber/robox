...
static char moveit_msgs__msg__GenericTrajectory__FIELD_NAME__header[] = "header";
static char moveit_msgs__msg__GenericTrajectory__FIELD_NAME__joint_trajectory[] = "joint_trajectory";
static char moveit_msgs__msg__GenericTrajectory__FIELD_NAME__cartesian_trajectory[] = "cartesian_trajectory";

static rosidl_runtime_c__type_description__Field moveit_msgs__msg__GenericTrajectory__FIELDS[] = {
  {
    {moveit_msgs__msg__GenericTrajectory__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {moveit_msgs__msg__GenericTrajectory__FIELD_NAME__joint_trajectory, 16, 16},
    {
  ...
  {
    {moveit_msgs__msg__GenericTrajectory__FIELD_NAME__cartesian_trajectory, 20, 20},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE_UNBOUNDED_SEQUENCE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription moveit_msgs__msg__GenericTrajectory__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {moveit_msgs__msg__GenericTrajectory__FIELDS, 3, 3},
    },
    {moveit_msgs__msg__GenericTrajectory__REFERENCED_TYPE_DESCRIPTIONS, 14, 14},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[8].fields = moveit_msgs__msg__CartesianPoint__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[9].fields = moveit_msgs__msg__CartesianTrajectory__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[10].fields = moveit_msgs__msg__CartesianTrajectoryPoint__get_type_description(NULL)->type_description.fields;
...
moveit_msgs__msg__GenericTrajectory__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *moveit_msgs__msg__GenericTrajectory__get_individual_type_description_source(NULL),
    ...
    sources[9] = *moveit_msgs__msg__CartesianPoint__get_individual_type_description_source(NULL);
    sources[10] = *moveit_msgs__msg__CartesianTrajectory__get_individual_type_description_source(NULL);
    sources[11] = *moveit_msgs__msg__CartesianTrajectoryPoint__get_individual_type_description_source(NULL);
