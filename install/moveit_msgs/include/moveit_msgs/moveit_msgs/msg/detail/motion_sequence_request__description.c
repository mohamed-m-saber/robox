...
moveit_msgs__msg__MotionSequenceRequest__get_type_hash(
...
static char moveit_msgs__msg__MotionSequenceRequest__FIELD_NAME__items[] = "items";

static rosidl_runtime_c__type_description__Field moveit_msgs__msg__MotionSequenceRequest__FIELDS[] = {
  {
    {moveit_msgs__msg__MotionSequenceRequest__FIELD_NAME__items, 5, 5},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription moveit_msgs__msg__MotionSequenceRequest__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
...
moveit_msgs__msg__MotionSequenceRequest__get_type_description(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {moveit_msgs__msg__MotionSequenceRequest__FIELDS, 1, 1},
    },
    {moveit_msgs__msg__MotionSequenceRequest__REFERENCED_TYPE_DESCRIPTIONS, 40, 40},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[26].fields = moveit_msgs__msg__RobotState__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[27].fields = moveit_msgs__msg__TrajectoryConstraints__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[28].fields = moveit_msgs__msg__VisibilityConstraint__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[29].fields = moveit_msgs__msg__WorkspaceParameters__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[30].fields = object_recognition_msgs__msg__ObjectType__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[31].fields = sensor_msgs__msg__JointState__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[32].fields = sensor_msgs__msg__MultiDOFJointState__get_type_description(NULL)->type_description.fields;
    assert(0 == memcmp(&shape_msgs__msg__Mesh__EXPECTED_HASH, shape_msgs__msg__Mesh__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[33].fields = shape_msgs__msg__Mesh__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[34].fields = shape_msgs__msg__MeshTriangle__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[35].fields = shape_msgs__msg__Plane__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[36].fields = shape_msgs__msg__SolidPrimitive__get_type_description(NULL)->type_description.fields;
...
moveit_msgs__msg__MotionSequenceRequest__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
...
moveit_msgs__msg__MotionSequenceRequest__get_type_description_sources(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *moveit_msgs__msg__MotionSequenceRequest__get_individual_type_description_source(NULL),
    ...
    sources[27] = *moveit_msgs__msg__RobotState__get_individual_type_description_source(NULL);
    sources[28] = *moveit_msgs__msg__TrajectoryConstraints__get_individual_type_description_source(NULL);
    sources[29] = *moveit_msgs__msg__VisibilityConstraint__get_individual_type_description_source(NULL);
    sources[30] = *moveit_msgs__msg__WorkspaceParameters__get_individual_type_description_source(NULL);
    sources[31] = *object_recognition_msgs__msg__ObjectType__get_individual_type_description_source(NULL);
    sources[32] = *sensor_msgs__msg__JointState__get_individual_type_description_source(NULL);
    sources[33] = *sensor_msgs__msg__MultiDOFJointState__get_individual_type_description_source(NULL);
    sources[34] = *shape_msgs__msg__Mesh__get_individual_type_description_source(NULL);
    sources[35] = *shape_msgs__msg__MeshTriangle__get_individual_type_description_source(NULL);
    sources[36] = *shape_msgs__msg__Plane__get_individual_type_description_source(NULL);
    sources[37] = *shape_msgs__msg__SolidPrimitive__get_individual_type_description_source(NULL);
