...
static char moveit_msgs__msg__PlaceLocation__FIELD_NAME__id[] = "id";
static char moveit_msgs__msg__PlaceLocation__FIELD_NAME__post_place_posture[] = "post_place_posture";
static char moveit_msgs__msg__PlaceLocation__FIELD_NAME__place_pose[] = "place_pose";
static char moveit_msgs__msg__PlaceLocation__FIELD_NAME__quality[] = "quality";
static char moveit_msgs__msg__PlaceLocation__FIELD_NAME__pre_place_approach[] = "pre_place_approach";
static char moveit_msgs__msg__PlaceLocation__FIELD_NAME__post_place_retreat[] = "post_place_retreat";
static char moveit_msgs__msg__PlaceLocation__FIELD_NAME__allowed_touch_objects[] = "allowed_touch_objects";

static rosidl_runtime_c__type_description__Field moveit_msgs__msg__PlaceLocation__FIELDS[] = {
  {
    {moveit_msgs__msg__PlaceLocation__FIELD_NAME__id, 2, 2},
    {
  ...
  {
    {moveit_msgs__msg__PlaceLocation__FIELD_NAME__post_place_posture, 18, 18},
    {
  ...
  {
    {moveit_msgs__msg__PlaceLocation__FIELD_NAME__place_pose, 10, 10},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {moveit_msgs__msg__PlaceLocation__FIELD_NAME__quality, 7, 7},
    {
  ...
  {
    {moveit_msgs__msg__PlaceLocation__FIELD_NAME__pre_place_approach, 18, 18},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {moveit_msgs__msg__PlaceLocation__FIELD_NAME__post_place_retreat, 18, 18},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {moveit_msgs__msg__PlaceLocation__FIELD_NAME__allowed_touch_objects, 21, 21},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription moveit_msgs__msg__PlaceLocation__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {moveit_msgs__msg__PlaceLocation__FIELDS, 7, 7},
    },
    {moveit_msgs__msg__PlaceLocation__REFERENCED_TYPE_DESCRIPTIONS, 12, 12},
  };
  if (!constructed) {
...
moveit_msgs__msg__PlaceLocation__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  static const rosidl_runtime_c__type_description__TypeSource source = {
    {moveit_msgs__msg__PlaceLocation__TYPE_NAME, 29, 29},
    {msg_encoding, 3, 3},
    {toplevel_type_raw_source, 752, 752},
  };
  return &source;
}
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *moveit_msgs__msg__PlaceLocation__get_individual_type_description_source(NULL),
