...
static char moveit_msgs__msg__MotionSequenceResponse__FIELD_NAME__error_code[] = "error_code";
static char moveit_msgs__msg__MotionSequenceResponse__FIELD_NAME__sequence_start[] = "sequence_start";
static char moveit_msgs__msg__MotionSequenceResponse__FIELD_NAME__planned_trajectories[] = "planned_trajectories";
static char moveit_msgs__msg__MotionSequenceResponse__FIELD_NAME__planning_time[] = "planning_time";

static rosidl_runtime_c__type_description__Field moveit_msgs__msg__MotionSequenceResponse__FIELDS[] = {
  {
    {moveit_msgs__msg__MotionSequenceResponse__FIELD_NAME__error_code, 10, 10},
    {
  ...
  {
    {moveit_msgs__msg__MotionSequenceResponse__FIELD_NAME__sequence_start, 14, 14},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {moveit_msgs__msg__MotionSequenceResponse__FIELD_NAME__planned_trajectories, 20, 20},
    {
  ...
  {
    {moveit_msgs__msg__MotionSequenceResponse__FIELD_NAME__planning_time, 13, 13},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription moveit_msgs__msg__MotionSequenceResponse__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {moveit_msgs__msg__MotionSequenceResponse__FIELDS, 4, 4},
    },
    {moveit_msgs__msg__MotionSequenceResponse__REFERENCED_TYPE_DESCRIPTIONS, 28, 28},
  };
  if (!constructed) {
...
moveit_msgs__msg__MotionSequenceResponse__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *moveit_msgs__msg__MotionSequenceResponse__get_individual_type_description_source(NULL),
