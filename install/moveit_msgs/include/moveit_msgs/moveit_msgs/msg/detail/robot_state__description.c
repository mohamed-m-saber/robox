...
static char moveit_msgs__msg__RobotState__FIELD_NAME__joint_state[] = "joint_state";
static char moveit_msgs__msg__RobotState__FIELD_NAME__multi_dof_joint_state[] = "multi_dof_joint_state";
static char moveit_msgs__msg__RobotState__FIELD_NAME__attached_collision_objects[] = "attached_collision_objects";
static char moveit_msgs__msg__RobotState__FIELD_NAME__is_diff[] = "is_diff";

static rosidl_runtime_c__type_description__Field moveit_msgs__msg__RobotState__FIELDS[] = {
  {
    {moveit_msgs__msg__RobotState__FIELD_NAME__joint_state, 11, 11},
    {
  ...
  {
    {moveit_msgs__msg__RobotState__FIELD_NAME__multi_dof_joint_state, 21, 21},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {moveit_msgs__msg__RobotState__FIELD_NAME__attached_collision_objects, 26, 26},
    {
  ...
  {
    {moveit_msgs__msg__RobotState__FIELD_NAME__is_diff, 7, 7},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription moveit_msgs__msg__RobotState__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {moveit_msgs__msg__RobotState__FIELDS, 4, 4},
    },
    {moveit_msgs__msg__RobotState__REFERENCED_TYPE_DESCRIPTIONS, 23, 23},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[14].fields = sensor_msgs__msg__JointState__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[15].fields = sensor_msgs__msg__MultiDOFJointState__get_type_description(NULL)->type_description.fields;
    assert(0 == memcmp(&shape_msgs__msg__Mesh__EXPECTED_HASH, shape_msgs__msg__Mesh__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[16].fields = shape_msgs__msg__Mesh__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[17].fields = shape_msgs__msg__MeshTriangle__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[18].fields = shape_msgs__msg__Plane__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[19].fields = shape_msgs__msg__SolidPrimitive__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[21].fields = trajectory_msgs__msg__JointTrajectory__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[22].fields = trajectory_msgs__msg__JointTrajectoryPoint__get_type_description(NULL)->type_description.fields;
    constructed = true;
  }
  return &description;
}
...
moveit_msgs__msg__RobotState__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *moveit_msgs__msg__RobotState__get_individual_type_description_source(NULL),
    ...
    sources[15] = *sensor_msgs__msg__JointState__get_individual_type_description_source(NULL);
    sources[16] = *sensor_msgs__msg__MultiDOFJointState__get_individual_type_description_source(NULL);
    sources[17] = *shape_msgs__msg__Mesh__get_individual_type_description_source(NULL);
    sources[18] = *shape_msgs__msg__MeshTriangle__get_individual_type_description_source(NULL);
    sources[19] = *shape_msgs__msg__Plane__get_individual_type_description_source(NULL);
    sources[20] = *shape_msgs__msg__SolidPrimitive__get_individual_type_description_source(NULL);
    sources[21] = *std_msgs__msg__Header__get_individual_type_description_source(NULL);
    sources[22] = *trajectory_msgs__msg__JointTrajectory__get_individual_type_description_source(NULL);
    sources[23] = *trajectory_msgs__msg__JointTrajectoryPoint__get_individual_type_description_source(NULL);
    constructed = true;
  }
