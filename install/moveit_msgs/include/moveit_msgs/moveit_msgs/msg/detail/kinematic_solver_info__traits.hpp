...
// IWYU pragma: private, include "moveit_msgs/msg/kinematic_solver_info.hpp"
...
inline std::string to_yaml(const KinematicSolverInfo & msg, bool use_flow_style = false)
{
