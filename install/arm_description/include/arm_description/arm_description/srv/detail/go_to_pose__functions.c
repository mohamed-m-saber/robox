...
arm_description__srv__GoToPose_Request__init(arm_description__srv__GoToPose_Request * msg)
{
  ...
  if (!geometry_msgs__msg__Pose__init(&msg->target_pose)) {
    arm_description__srv__GoToPose_Request__fini(msg);
    return false;
  }
  return true;
}
...
arm_description__srv__GoToPose_Request__create(void)
{
  ...
  arm_description__srv__GoToPose_Request * msg = (arm_description__srv__GoToPose_Request *)allocator.allocate(sizeof(arm_description__srv__GoToPose_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(arm_description__srv__GoToPose_Request));
  bool success = arm_description__srv__GoToPose_Request__init(msg);
  if (!success) {
...
arm_description__srv__GoToPose_Request__Sequence__init(arm_description__srv__GoToPose_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  arm_description__srv__GoToPose_Request * data = NULL;

  if (size) {
    data = (arm_description__srv__GoToPose_Request *)allocator.zero_allocate(size, sizeof(arm_description__srv__GoToPose_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = arm_description__srv__GoToPose_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        arm_description__srv__GoToPose_Request__fini(&data[i - 1]);
      }
...
arm_description__srv__GoToPose_Request__Sequence__fini(arm_description__srv__GoToPose_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      arm_description__srv__GoToPose_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  arm_description__srv__GoToPose_Request__Sequence * array = (arm_description__srv__GoToPose_Request__Sequence *)allocator.allocate(sizeof(arm_description__srv__GoToPose_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = arm_description__srv__GoToPose_Request__Sequence__init(array, size);
  if (!success) {
...
arm_description__srv__GoToPose_Request__Sequence__destroy(arm_description__srv__GoToPose_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    arm_description__srv__GoToPose_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
arm_description__srv__GoToPose_Request__Sequence__are_equal(const arm_description__srv__GoToPose_Request__Sequence * lhs, const arm_description__srv__GoToPose_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!arm_description__srv__GoToPose_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  arm_description__srv__GoToPose_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(arm_description__srv__GoToPose_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    arm_description__srv__GoToPose_Request * data =
      (arm_description__srv__GoToPose_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!arm_description__srv__GoToPose_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          arm_description__srv__GoToPose_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!arm_description__srv__GoToPose_Request__copy(
...
arm_description__srv__GoToPose_Response__init(arm_description__srv__GoToPose_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->message)) {
    arm_description__srv__GoToPose_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  arm_description__srv__GoToPose_Response * msg = (arm_description__srv__GoToPose_Response *)allocator.allocate(sizeof(arm_description__srv__GoToPose_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(arm_description__srv__GoToPose_Response));
  bool success = arm_description__srv__GoToPose_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
arm_description__srv__GoToPose_Response__Sequence__init(arm_description__srv__GoToPose_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  arm_description__srv__GoToPose_Response * data = NULL;

  if (size) {
    data = (arm_description__srv__GoToPose_Response *)allocator.zero_allocate(size, sizeof(arm_description__srv__GoToPose_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = arm_description__srv__GoToPose_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        arm_description__srv__GoToPose_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
arm_description__srv__GoToPose_Response__Sequence__fini(arm_description__srv__GoToPose_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      arm_description__srv__GoToPose_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  arm_description__srv__GoToPose_Response__Sequence * array = (arm_description__srv__GoToPose_Response__Sequence *)allocator.allocate(sizeof(arm_description__srv__GoToPose_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = arm_description__srv__GoToPose_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
arm_description__srv__GoToPose_Response__Sequence__destroy(arm_description__srv__GoToPose_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    arm_description__srv__GoToPose_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
arm_description__srv__GoToPose_Response__Sequence__are_equal(const arm_description__srv__GoToPose_Response__Sequence * lhs, const arm_description__srv__GoToPose_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!arm_description__srv__GoToPose_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  arm_description__srv__GoToPose_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(arm_description__srv__GoToPose_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    arm_description__srv__GoToPose_Response * data =
      (arm_description__srv__GoToPose_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!arm_description__srv__GoToPose_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          arm_description__srv__GoToPose_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!arm_description__srv__GoToPose_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
arm_description__srv__GoToPose_Event__init(arm_description__srv__GoToPose_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    arm_description__srv__GoToPose_Event__fini(msg);
    return false;
  }
  // request
  if (!arm_description__srv__GoToPose_Request__Sequence__init(&msg->request, 0)) {
    arm_description__srv__GoToPose_Event__fini(msg);
    return false;
  }
  // response
  if (!arm_description__srv__GoToPose_Response__Sequence__init(&msg->response, 0)) {
    arm_description__srv__GoToPose_Event__fini(msg);
    return false;
  }
  return true;
...
arm_description__srv__GoToPose_Event__fini(arm_description__srv__GoToPose_Event * msg)
{
  ...
  // request
  arm_description__srv__GoToPose_Request__Sequence__fini(&msg->request);
  // response
  arm_description__srv__GoToPose_Response__Sequence__fini(&msg->response);
}
...
arm_description__srv__GoToPose_Event__are_equal(const arm_description__srv__GoToPose_Event * lhs, const arm_description__srv__GoToPose_Event * rhs)
{
  ...
  // request
  if (!arm_description__srv__GoToPose_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!arm_description__srv__GoToPose_Response__Sequence__are_equal(
  ...
  arm_description__srv__GoToPose_Event * output)
{
  ...
  // request
  if (!arm_description__srv__GoToPose_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!arm_description__srv__GoToPose_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  arm_description__srv__GoToPose_Event * msg = (arm_description__srv__GoToPose_Event *)allocator.allocate(sizeof(arm_description__srv__GoToPose_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(arm_description__srv__GoToPose_Event));
  bool success = arm_description__srv__GoToPose_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
arm_description__srv__GoToPose_Event__Sequence__init(arm_description__srv__GoToPose_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  arm_description__srv__GoToPose_Event * data = NULL;

  if (size) {
    data = (arm_description__srv__GoToPose_Event *)allocator.zero_allocate(size, sizeof(arm_description__srv__GoToPose_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = arm_description__srv__GoToPose_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        arm_description__srv__GoToPose_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
arm_description__srv__GoToPose_Event__Sequence__fini(arm_description__srv__GoToPose_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      arm_description__srv__GoToPose_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  arm_description__srv__GoToPose_Event__Sequence * array = (arm_description__srv__GoToPose_Event__Sequence *)allocator.allocate(sizeof(arm_description__srv__GoToPose_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = arm_description__srv__GoToPose_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
arm_description__srv__GoToPose_Event__Sequence__destroy(arm_description__srv__GoToPose_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    arm_description__srv__GoToPose_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
arm_description__srv__GoToPose_Event__Sequence__are_equal(const arm_description__srv__GoToPose_Event__Sequence * lhs, const arm_description__srv__GoToPose_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!arm_description__srv__GoToPose_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  arm_description__srv__GoToPose_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(arm_description__srv__GoToPose_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    arm_description__srv__GoToPose_Event * data =
      (arm_description__srv__GoToPose_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!arm_description__srv__GoToPose_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          arm_description__srv__GoToPose_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!arm_description__srv__GoToPose_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
